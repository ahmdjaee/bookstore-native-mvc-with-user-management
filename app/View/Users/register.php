<nav class="nav nav-pills nav-justified position-absolute w-100 d-flex justify-content-end pe-5 pt-5">
    <div class="d-flex gap-3">
        <a class="nav-link active shadow-sm" aria-current="page" href="">Register</a>
        <a class="nav-link shadow-sm" style="background-color: white;" href="login">Login</a>
    </div>
</nav>
        ...
        <div class="container " style="width: 30%; height: 50vh">
            <form method="post">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Name" aria-label="Name" name="name" value="<?= $_POST['name'] ?? '' ?>" aria-describedby="basic-addon1">
                </div>
